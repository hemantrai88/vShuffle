...
template.pages = [
  {name: 'Factory', hash: 'one', url: 'firstPage'},
  {name: 'Boards', hash: 'two', url: '//www.html5rocks.com/en/tutorials/webcomponents/shadowdom-201/'},
  {name: 'Feed', hash: 'three', url: '//www.html5rocks.com/en/tutorials/webcomponents/shadowdom-301/'},
  {name: 'Profile', hash: 'four', url: '//www.html5rocks.com/en/tutorials/webcomponents/customelements/'}
];
...
template.onResponse = function(e, detail, sender) {
  ...
  if(article.querySelector('.byline')){
